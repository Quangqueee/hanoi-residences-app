...
## Corpus Check
- 81 files · ~105,086 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 542 nodes · 1022 edges · 57 communities (24 shown, 33 thin omitted)
...
Cohesion: 0.09
Nodes (29): getAuthErrorMessage(), LoginScreen(), styles, getAuthErrorMessage(), SignupScreen(), styles, styles, styles (+21 more)
...
### Community 2 - "[id].tsx"
Cohesion: 0.08
Nodes (45): ApartmentDetailScreen(), buildInternalCopyText(), getLandlordPhone(), softShadow, UI, FavoritesScreen(), styles, UI (+37 more)
...
Cohesion: 0.07
Nodes (32): AuthContext, AuthContextValue, AuthProvider(), auth, firebaseApp, storage, ensureAndroidChannel(), presentLocalNotification() (+24 more)

### Community 5 - "useAuth"
Cohesion: 0.09
Nodes (29): expo-router, Index(), RootNavigator(), TabsLayout(), TabUI, NotificationsScreen(), styles, initialsFromName() (+21 more)
...
### Community 27 - "quick-download-button.tsx"
Cohesion: 0.38
